import { BASE_URL, COLLECTION_SIX } from '@/config/config';
...
const getImageUrl = (imageName: string): string => `${BASE_URL}/${COLLECTION_SIX}/${imageName}`;

// IMAGES (loaded from S3)
const imageOne = <Photo image={getImageUrl('Arosa-1.jpg')} caption={captionEmpty} />;
const imageTwo = <Photo image={getImageUrl('Arosa-2.jpg')} caption={captionEmpty} />;
const imageThree = <Photo image={getImageUrl('Arosa-3.jpg')} caption={captionEmpty} />;
const imageFour = <Photo image={getImageUrl('Arosa-4.jpg')} caption={captionEmpty} />;
const imageFive = <Photo image={getImageUrl('Arosa-5.jpg')} caption={captionEmpty} />;
const imageSix = <Photo image={getImageUrl('Arosa-6.jpg')} caption={captionEmpty} />;
const imageSeven = <Photo image={getImageUrl('Arosa-7.jpg')} caption={captionEmpty} />;

// TITLE Section
export const title = <Title title="Arosa" />;
...
export const gallery = (
  <Gallery>
    <DoubleRow componentOne={imageOne} componentTwo={imageTwo} />
    <TripleRow componentOne={imageThree} componentTwo={imageFour} componentThree={imageFive} />
    <DoubleRow componentOne={imageSix} componentTwo={imageSeven} />
  </Gallery>
);
