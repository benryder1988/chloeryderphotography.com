import { BASE_URL, COLLECTION_AUTUMN_GARDEN } from '@/config/config';
...
const getImageUrl = (imageName: string): string => `${BASE_URL}/${COLLECTION_AUTUMN_GARDEN}/${imageName}`;

// IMAGES (loaded from S3)
const imageOne = <Photo image={getImageUrl('Autumn_WE-47.jpg')} caption={captionEmpty} />;
const imageTwo = <Photo image={getImageUrl('Autumn_WE-48.jpg')} caption={captionEmpty} />;
const imageThree = <Photo image={getImageUrl('Autumn_WE-50.jpg')} caption={captionEmpty} />;
const imageFour = <Photo image={getImageUrl('Autumn_WE-56.jpg')} caption={captionEmpty} />;
const imageFive = <Photo image={getImageUrl('Autumn_WE-60.jpg')} caption={captionEmpty} />;
const imageSix = <Photo image={getImageUrl('Autumn_WE-62.jpg')} caption={captionEmpty} />;

// TITLE Section
export const title = <Title title="The Autumn Garden" />;
...
export const gallery = (
  <Gallery>
    ...
    <DoubleRow componentOne={imageFour} componentTwo={imageThree} />
    <DoubleRow componentOne={imageFive} componentTwo={imageSix} />
  </Gallery>
);
